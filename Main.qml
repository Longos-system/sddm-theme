...
Item {
    ...
    Image {
        id: wallpaperImage
        anchors.fill: parent
        source: "file://" + "/usr/share/backgrounds/longos/default.jpg"
    ...
    Item {
        ...
        width: 260 + LongUI.Units.largeSpacing * 3
    ...
    Item {
        ...
        width: sessionMenu.implicitWidth + LongUI.Units.largeSpacing
    ...
    Item {
        ...
        width: 50
        height: 50 + LongUI.Units.largeSpacing
        ...
        LongUI.RoundImageButton {
            ...
            iconMargins: LongUI.Units.largeSpacing
