...
T.Menu
{
    ...
    background: LongUI.RoundedRect {
        radius: LongUI.Theme.hugeRadius
        opacity: 1
    ...
    T.Overlay.modal: Rectangle  {
        color: Qt.rgba(control.LongUI.Theme.backgroundColor.r,
                       control.LongUI.Theme.backgroundColor.g,
                       control.LongUI.Theme.backgroundColor.b, 0.4)
        Behavior on opacity {
            NumberAnimation {
                duration: 150
                easing.type: Easing.InOutCubic
